<?php
namespace Mrlaozhou\Aliyun\Uploader;
/**
...
class AliyunVodUploader
{
    ...
    public function __construct($accessKeyId = null, $accessKeySecret = null, $apiRegionId=null)
    {
        $this->accessKeyId = $accessKeyId ?: config('aliopen.accessKeyId');
        $this->accessKeySecret = $accessKeySecret ?: config('aliopen.accessKeySecret');
        $this->apiRegionId = $apiRegionId ?: config('aliopen.apiRegionId', 'cn-shanghai');
